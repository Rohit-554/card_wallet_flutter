...
class CardUtils {
  static CardType getCardTypeFrmNumber(String input) {
    if (input.startsWith(RegExp(
      ...
      return CardType.Jcb;
    } else if (input.startsWith(RegExp(r'((60[0-9])|(6521))'))) {
      return CardType.Rupay;
    } else if (input.startsWith(RegExp(r'((50[0-9])|(56[0-9])|(57[0-9])|(58[0-9])|(59[0-9])|(6[0-9]))'))) {
  ...
  static Widget? getCardIcon(CardType? cardType) {
    ...
    switch (cardType) {
      ...
      case CardType.AmericanExpress:
        img = 'assets/icons/american-express.svg';
        break;
      case CardType.Discover:
        img = 'assets/icons/payment.svg';
        break;
      case CardType.DinersClub:
        img = 'assets/icons/dinersclub.svg';
        break;
      case CardType.Jcb:
        img = 'assets/icons/jcb.svg';
        break;
